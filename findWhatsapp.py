...
class findWhatsappIngestModuleFactory(IngestModuleFactoryAdapter):

    # TODO: give it a unique name.  Will be shown in module list, logs, etc.
    moduleName = "Find Whatsapps"
    ...
    def getModuleDescription(self):
        return "Find whatsapp chat databases."
...
class SampleJythonDataSourceIngestModule(DataSourceIngestModule):
    ...
    _logger = Logger.getLogger(findWhatsappIngestModuleFactory.moduleName)
    ...
    def process(self, dataSource, progressBar):
        ...
        contactFiles = fileManager.findFiles(dataSource, "wa.db")
        #BitTorrentForensic = fileManager.findFiles(dataSource, "%", "/Roaming/BitTorrent")

        numFiles = len(contactFiles)
        ...
        for file in contactFiles:
            ...
            att = BlackboardAttribute(BlackboardAttribute.ATTRIBUTE_TYPE.TSK_SET_NAME, findWhatsappIngestModuleFactory.moduleName, "Whastapp Contacts Detected")
